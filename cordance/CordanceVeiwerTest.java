...
public class CordanceVeiwerTest {
	...
	public void test() {
		...
		assertEquals("hello", tester.getCordance(searchWord, 0), '\r'+"0: vex ");	

		//check it returns the words before and after the chosen word, in this case its just 1 word
		assertEquals(tester.getCordance(searchWord, 1), '\r'+"0: or vex her. ");	
		
		//check that the spaces at the end are removed
		assertEquals(tester.getCordance(searchWord, 2), '\r'+"0: distress or vex her. ");
